...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        //This is an example of implicit type casting (widening) because float data type is wider than int data type.
        ...
        //int data type can only store whole numbers. The decimal part will be truncated.
        ...
        //How is it able to store 2000 in int data type when it is performing arithmetic operations on byte data type?
        //This is because when we perform arithmetic operations on byte data type, it is automatically converted
        //to int data type by the compiler. This is called automatic type casting (widening). 
        ...
        //because 50*2 = 100.
        //How is it able to store 100 in byte data type when it is performing arithmetic operations on byte data type?
        //This is because when we perform arithmetic operations on byte data type, it is automatically converted
        //to int data type by the compiler. This is called automatic type casting (widening). 
        // So, the result of the arithmetic operation is stored in int data type. 
        // But we are trying to store it in byte data type which is narrower than int data type.
        //  So, we need to explicitly type cast it to byte data type. This is

        //Java follows unicode standard for character data type. It uses 2 bytes to store a character. 
        //So, it can store 65536 characters.
        //It can store characters from different languages and symbols. It can also store emojis.

        //Type Promotion Rules in Java:
        //1. All the byte, short and char values are promoted to int when they are used in an expression.
        ...
        //4. If any of the operands is double, the whole expression is promoted to double
        ...
        //Suppose input is 42, 'a', 1024, 50000, 5.67 and 0.1234 , it will be stored in result variable as 50000.0
        //because (5.67*42) + (50000/'a') - (0.1234*1024) = 238.14 + 515 - 126.3616 = 626.7784
        //The result is stored in double data type because it is the widest data type among all the operands.
        //Here a is promoted to int data type because it is used in an expression with int data type.
        //Value of 'a' is 97 in unicode standard. So, 50000/'a' = 50000/97 = 515.4639175257732
