...
public class Primitives {
    public static void main(String[] args) {
        ...
        // This is useful to get additional methods and functionalities to the primitive
        // data types.
        // Automatic conversion of primitive data types to wrapper classes is called
        // autoboxing.
        // Automatic conversion of wrapper classes to primitive data types is called
        // unboxing.

        int a = 10;
        // Here a is literal value of int data type. We can also use wrapper classes to
        // convert literal values into objects.

        // int a = 234_000_000;
        // We can use underscore to make the number more readable. It will not affect
        // the value of the number.
        // It will replace with comma in the number. For example, 234_000_000 will be
        // treated as 234,000,000.
    }
}